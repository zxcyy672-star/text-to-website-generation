...
# ========= 2️⃣ النص العربي =========
arabic_description = """
موقع ويب متجاوب لمعرض فني اسمه ArtVerse يعرض أعمال فنية حديثة وكلاسيكية.
يستخدم اللون DarkSlateGray في الرأس وشريط التنقل،
والأبيض للخلفية،
والرمادي الفاتح لأقسام المحتوى،
والذهبي للعناصر التفاعلية مثل الأزرار.
يحتوي شريط التنقل على: الرئيسية، المعرض، الفنانون، المعارض، واتصل بنا.
يتضمن الموقع صورًا فنية مثل لوحة تجريدية وبورتريه كلاسيكي وعمل فني رقمي.
يتكيف التصميم بسلاسة مع الشاشات الصغيرة باستخدام media queries.
"""
...
# ========= 5️⃣ حفظ الناتج =========
output_file = "generated_from_arabic.html"
