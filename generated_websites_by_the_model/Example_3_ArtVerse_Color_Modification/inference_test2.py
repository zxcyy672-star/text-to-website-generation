...
# ========= 2️⃣ النص العربي =========
description = "A responsive website for an art gallery named ArtVerse that showcases modern and classic artworks. The color scheme uses royal blue for the header and navigation, teal for background, light gray for content sections, and crimson for interactive elements like buttons and highlights. The navigation bar includes: Home, Gallery, Artists, Exhibitions, and Contact. The website includes artistic images: an abstract painting, a classical portrait, and a digital art piece. The layout adjusts smoothly for small screens using media queries."
...
# ========= 5️⃣ حفظ الناتج =========
output_file = "generated_change_color.html"
